...
//         // FIX 1: Pass false instead of throwing a hard error object to prevent socket crashes
//         callback(null, false); 
//       },
//       methods: ["GET", "POST"],
//       credentials: true,
//       // FIX 2: Allow Brave browser client hints and origin routing headers explicitly
//       allowedHeaders: [
//         "Content-Type",
//         "Authorization",
//         "accept",
